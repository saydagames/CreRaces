...
import mc.sayda.creraces.item.RadixCrystalItem;
...
public class MakeRadixProcedure extends CreracesModElements.ModElement {
	public MakeRadixProcedure(CreracesModElements instance) {
		super(instance, 16);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure MakeRadix!");
			return;
		}
		...
		if (entity instanceof PlayerEntity) {
			ItemStack _stktoremove = new ItemStack(RadixCrystalItem.block, (int) (1));
