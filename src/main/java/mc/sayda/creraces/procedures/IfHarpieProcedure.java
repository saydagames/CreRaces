...
public class IfHarpieProcedure extends CreracesModElements.ModElement {
	public IfHarpieProcedure(CreracesModElements instance) {
		super(instance, 9);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure IfHarpie!");
			return;
		}
