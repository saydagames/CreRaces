...
import mc.sayda.creraces.item.FlamekinCrystalItem;
...
public class MakeFlamekinProcedure extends CreracesModElements.ModElement {
	public MakeFlamekinProcedure(CreracesModElements instance) {
		super(instance, 6);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure MakeFlamekin!");
			return;
		}
		...
		if (entity instanceof PlayerEntity) {
			ItemStack _stktoremove = new ItemStack(FlamekinCrystalItem.block, (int) (1));
