...
public class AirBubble7Procedure extends CreracesModElements.ModElement {
	public AirBubble7Procedure(CreracesModElements instance) {
		super(instance, 62);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure AirBubble7!");
			return false;
		}
