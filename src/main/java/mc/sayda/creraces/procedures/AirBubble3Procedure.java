...
public class AirBubble3Procedure extends CreracesModElements.ModElement {
	public AirBubble3Procedure(CreracesModElements instance) {
		super(instance, 58);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure AirBubble3!");
			return false;
		}
