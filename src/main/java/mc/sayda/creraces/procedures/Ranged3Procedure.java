...
public class Ranged3Procedure extends CreracesModElements.ModElement {
	public Ranged3Procedure(CreracesModElements instance) {
		super(instance, 97);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure Ranged3!");
			return;
		}
