...
public class AirBubble1Procedure extends CreracesModElements.ModElement {
	public AirBubble1Procedure(CreracesModElements instance) {
		super(instance, 55);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure AirBubble1!");
			return false;
		}
