...
public class AirBubble8Procedure extends CreracesModElements.ModElement {
	public AirBubble8Procedure(CreracesModElements instance) {
		super(instance, 63);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure AirBubble8!");
			return false;
		}
