...
public class Melee3Procedure extends CreracesModElements.ModElement {
	public Melee3Procedure(CreracesModElements instance) {
		super(instance, 101);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure Melee3!");
			return;
		}
