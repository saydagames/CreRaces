...
public class AirBubble2Procedure extends CreracesModElements.ModElement {
	public AirBubble2Procedure(CreracesModElements instance) {
		super(instance, 57);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure AirBubble2!");
			return false;
		}
