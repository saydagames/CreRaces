...
public class IfFlamekinActiveProcedure extends CreracesModElements.ModElement {
	public IfFlamekinActiveProcedure(CreracesModElements instance) {
		super(instance, 28);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure IfFlamekinActive!");
			return;
		}
