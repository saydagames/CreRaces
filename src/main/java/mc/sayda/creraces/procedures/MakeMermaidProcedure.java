...
import mc.sayda.creraces.item.MermaidCrystalItem;
...
public class MakeMermaidProcedure extends CreracesModElements.ModElement {
	public MakeMermaidProcedure(CreracesModElements instance) {
		super(instance, 12);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CreracesMod.LOGGER.warn("Failed to load dependency entity for procedure MakeMermaid!");
			return;
		}
		...
		if (entity instanceof PlayerEntity) {
			ItemStack _stktoremove = new ItemStack(MermaidCrystalItem.block, (int) (1));
