...
public class DominatorEntity extends CreracesModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("creraces:entitybulletdominator")
	public static final EntityType arrow = null;
	public DominatorEntity(CreracesModElements instance) {
		super(instance, 105);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(1f, 1f)).build("dominator")
						.setRegistryName("dominator");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -6750208, -39373, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dominator_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletdominator").setRegistryName("entitybulletdominator"));
	}
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new GhastModel(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("creraces:textures/ghastnether00002.png");
				}
			});
