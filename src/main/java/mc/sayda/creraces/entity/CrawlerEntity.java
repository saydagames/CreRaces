...
public class CrawlerEntity extends CreracesModElements.ModElement {
	public static EntityType entity = null;
	public CrawlerEntity(CreracesModElements instance) {
		super(instance, 93);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1.4f, 0.9f)).build("crawler")
						.setRegistryName("crawler");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -39424, -10079488, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("crawler_spawn_egg"));
	}
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new SpiderModel(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("creraces:textures/spider.png");
				}
			});
		}
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(7, new MeleeAttackGoal(this, 1.8, false));
		}
