...
public class GhoulEntity extends CreracesModElements.ModElement {
	public static EntityType entity = null;
	public GhoulEntity(CreracesModElements instance) {
		super(instance, 87);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("ghoul")
						.setRegistryName("ghoul");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -10066330, -3355444, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ghoul_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("creraces:textures/ghoul.png");
					}
				};
