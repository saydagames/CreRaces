...
public class WandererEntity extends CreracesModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("creraces:entitybulletwanderer")
	public static final EntityType arrow = null;
	public WandererEntity(CreracesModElements instance) {
		super(instance, 94);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("wanderer")
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -3355444, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("wanderer_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletwanderer").setRegistryName("entitybulletwanderer"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("creraces:textures/death.png");
					}
				};
