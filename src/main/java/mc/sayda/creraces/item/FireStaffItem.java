...
public class FireStaffItem extends CreracesModElements.ModElement {
	@ObjectHolder("creraces:fire_staff")
	public static final Item block = null;
	@ObjectHolder("creraces:entitybulletfire_staff")
	public static final EntityType arrow = null;
	public FireStaffItem(CreracesModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(480));
